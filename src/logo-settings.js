import { HATCH_DEFAULTS, HATCH_FIXED_CMY, HATCH_SLIDERS } from './cross-hatch.js';
...
export const LOGO_DEFAULTS = Object.freeze({
  ...
  angle: 45, midpoint: 50, saturation: 100, highlight: 18, softness: 22, grain: 8,
...
export function readLogoSettings(input = {}) {
  ...
  for (const key of Object.keys(result)) {
    // Old saves may contain adjustable CMY weights. Keep their fixed defaults.
    if (Object.hasOwn(HATCH_FIXED_CMY, key)) continue;
