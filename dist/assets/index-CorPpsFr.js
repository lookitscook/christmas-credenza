const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./three.module-B6P4w-Uq.js","./three.module-BlVsInPO.js","./post-processing-BRe5Dhox.js","./tv-video-CEV2qEw4.js"])))=>i.map(i=>d[i]);
...
//#endregion
//#region src/scene.js
var TV_VIDEO_URL = new URL(new URL("11543712-hd_1920_1080_30fps-DAG6GmLG.mp4", import.meta.url).href, "" + import.meta.url).href;
...
try {
	...
	const { createTVVideo } = await __vitePreload(async () => {
		const { createTVVideo } = await import("./tv-video-CEV2qEw4.js");
		return { createTVVideo };
