import { $r as MeshPhysicalMaterial, no as SRGBColorSpace, ys as VideoTexture } from "./three.module-BlVsInPO.js";
//#region src/tv-video.js
function createTVVideo({ src, screen, root, invalidate }) {
	...
	async function play() {
		...
		try {
			...
			status.textContent = error.name === "NotAllowedError" ? "Click the scene to start the TV video." : "The TV video could not play. Check that the video file is available and supported.";
		}
	}
